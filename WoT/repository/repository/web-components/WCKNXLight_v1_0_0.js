...
export class WCKNXLight_v1_0_0 extends WCThingPack1_v1_0_0 {
    constructor() {
        super();
    ...
    connectedCallback() {
        ...
        this.mqttClient.setEvent('connect', (connack) => {
            ...
            this.getStatus(this);
            setInterval(() => this.getStatus(this), 1000000);
        ...
        this.mqttClient.setEvent('message', (hostname, port, topic, message, packet) => {
            console.log('messageKNXLight', message);
...
customElements.define('wc-knxlight', WCKNXLight_v1_0_0);